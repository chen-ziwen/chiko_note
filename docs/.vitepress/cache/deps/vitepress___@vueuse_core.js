...
function useEventListener(...args) {
  ...
  const stopWatch = watchImmediate(
    ...
    ([raw_targets, raw_events, raw_listeners, raw_options]) => {
      ...
      cleanups.push(
        ...raw_targets.flatMap((el) => raw_events.flatMap((event) => raw_listeners.map((listener) => register(el, event, listener, optionsClone))))
      )
    },
    { flush: 'post' }
  )
  ...
  useEventListener(
    ...
    () => {
      ...
      return (_focused.value =
        (_c = (_b = (_a = targetElement.value) == null ? void 0 : _a.matches) == null ? void 0 : _b.call(_a, PSEUDO_CLASS_FOCUS_WITHIN)) != null
          ? _c
          : false)
    },
    listenerOptions
